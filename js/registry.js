...
window.PrecisionCalcRegistry = {
  ...
  'cooking-convert': { id: 'cooking-convert', name: 'Cooking Measurement Converter', category: 'Daily Life', icon: '🥣', materialIcon: 'kitchen' },
  ...
  'date-diff': { id: 'date-diff', name: 'Date Difference Calculator', category: 'Daily Life', icon: '📅', materialIcon: 'event' },
  ...
  'matrix-ops': { id: 'matrix-ops', name: 'Matrix Addition/Multiplication', category: 'Math', icon: '⧉', materialIcon: 'grid_on' },
  ...
  'time-zone': { id: 'time-zone', name: 'Time Zone Converter', category: 'Daily Life', icon: '🌍', materialIcon: 'public' },
  'tip-split': { id: 'tip-split', name: 'Tip Splitter', category: 'Daily Life', icon: '💸', materialIcon: 'payments' },
